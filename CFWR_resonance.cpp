...
void CorrelationFunction::get_rapidity_dependence(double * rap_indep_vector, double * rap_dep_vector, double rap_val)
{
...
void CorrelationFunction::combine_sourcevariances(double * output, double * input, double * alpha_vec)
{
	//0, 1, 2, 3 --> t, o, s, l
	//[{1}_r]_{r-->\pi}
	output[0] += input[0];
